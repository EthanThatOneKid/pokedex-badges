export const renderPokedexEntry = (
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 50" width="195" height="45" role="img" style="border-radius: 10px; border: 5px solid black; background-color: #fff;">
