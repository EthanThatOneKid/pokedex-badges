export const renderPokedexEntry = (
  ...
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 50" width="200" height="50" role="img" style="background-color: #E61919; border-radius: 10px; border: 5px solid black;">
